			...
			<div className="jtm-container">
				...
				<div className="w-[950px] max-w-full mx-auto relative">
					<div className="relative md:absolute flex items-center justify-center h-[450px] md:w-full md:h-full">						
						<div className="absolute overflow-clip size-[332px] luta-bg-color rounded-full">
							<img className="h-full w-full object-cover" src={`https://yvixjgsliwyzmngtcsra.supabase.co/storage/v1/object/public/landings/${proyecto}/image2.jpg`} alt="" />
						</div>
